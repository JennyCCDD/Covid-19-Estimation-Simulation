...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>(count turtles with [not infected? and not recovered? and not exposed?]) / (count turtles) * 100</metric>
    <metric>(count turtles with [infected?]) / (count turtles) * 100</metric>
    <metric>(count turtles with [recovered?]) / (count turtles) * 100</metric>
    <metric>(count turtles with [exposed?])/(count turtles) * 100</metric>
    ...
    <steppedValueSet variable="recovery-chance" first="1" step="10" last="100"/>
    <steppedValueSet variable="exposed-chance" first="1" step="10" last="100"/>
    <steppedValueSet variable="virus-spread-chance" first="1" step="10" last="100"/>
